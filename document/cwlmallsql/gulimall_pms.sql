...
CREATE TABLE `pms_attr`  (
  ...
  `value_type` tinyint(0) NULL DEFAULT NULL COMMENT '是否多选',
  PRIMARY KEY (`attr_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品属性' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_attr
-- ----------------------------
INSERT INTO `pms_attr` VALUES (1, '入网参数', 1, 'xxx', '4G;5G', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (2, '上市年份', 1, 'xxx', '2019;2020;2021', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (3, '颜色', 1, 'xxx', '极光蓝;钛空银;霓影紫;流光幻镜', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (4, '颜色', 0, 'xxx', '极光蓝;钛空银;霓影紫;流光幻镜', 0, 1, 225, 0, 0);
INSERT INTO `pms_attr` VALUES (5, '内存', 0, 'xxx', '4G;6G;8G;12G', 0, 1, 225, 0, 0);
INSERT INTO `pms_attr` VALUES (7, 'CPU型号', 1, 'xxx1', '麒麟990;麒麟820', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (8, 'CPU工艺', 1, 'xxx', '7nm;5nm;3nm', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (9, '电池容量', 1, 'xxx', '3500mAh;4000mAh;5000mAh', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (10, '机身长度(mm)', 1, 'xxx', '168;155;172', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (12, 'CPU品牌', 1, 'xxx', '海思(Hisilicon);高通(Qualcomm)', 1, 1, 225, 1, 0);
INSERT INTO `pms_attr` VALUES (13, '入网型号', 1, 'xxx', 'aaa;bbb', 1, 1, 225, 1, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '属性&属性分组关联' ROW_FORMAT = Dynamic;
...
INSERT INTO `pms_attr_attrgroup_relation` VALUES (24, 13, 5, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (25, 2, 5, NULL);
INSERT INTO `pms_attr_attrgroup_relation` VALUES (26, 3, NULL, NULL);
...
INSERT INTO `pms_attr_group` VALUES (5, '主体', 0, '主体', 'xxx', 225);
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '品牌' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_brand
-- ----------------------------
INSERT INTO `pms_brand` VALUES (8, '小米', 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-04-26/2ac67e07-b2e9-40d6-8b98-6a9815b5447c_xiaomi.png', 'mi', 1, 'M', 2);
INSERT INTO `pms_brand` VALUES (11, '华为', 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-04-26/9e44aa81-1648-42b4-8e9e-05ec3886e496_huawei.png', 'HUAWEI', 1, 'H', 1);
INSERT INTO `pms_brand` VALUES (12, '苹果', 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-04-26/989e176f-6b5e-4fcb-8342-c4bd66c5b932_apple.png', '苹果', 1, 'A', 0);
INSERT INTO `pms_brand` VALUES (13, 'OPPO', 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-04-26/ae6a9e60-8a98-477b-89ac-4c8f576fb60c_oppo.png', 'OPPO', 1, 'O', 0);
...
CREATE TABLE `pms_category_brand_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '品牌分类关联' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_category_brand_relation
-- ----------------------------
INSERT INTO `pms_category_brand_relation` VALUES (6, 8, 225, '小米', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (7, 11, 225, '华为', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (8, 12, 225, '苹果', '手机');
INSERT INTO `pms_category_brand_relation` VALUES (9, 13, 225, 'OPPO', '手机');
...
CREATE TABLE `pms_comment_replay`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品评价回复关系' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_attr_value`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 122 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'spu属性值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_product_attr_value
-- ----------------------------
INSERT INTO `pms_product_attr_value` VALUES (106, 17, 9, '电池容量', '5000mAh', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (107, 17, 10, '机身长度(mm)', '172', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (108, 17, 7, 'CPU型号', '骁龙888', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (109, 17, 8, 'CPU工艺', '7nm', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (110, 17, 12, 'CPU品牌', '骁龙', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (111, 17, 2, '上市年份', '2022', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (112, 17, 13, '入网型号', 'aaa', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (113, 18, 9, '电池容量', '4000mAh', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (114, 18, 10, '机身长度(mm)', '155', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (115, 18, 7, 'CPU型号', '骁龙888', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (116, 18, 8, 'CPU工艺', '5nm', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (117, 18, 12, 'CPU品牌', '苹果', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (118, 18, 2, '上市年份', '2022', NULL, 1);
INSERT INTO `pms_product_attr_value` VALUES (119, 18, 13, '入网型号', 'bbb', NULL, 1);
...
CREATE TABLE `pms_sku_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 107 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'sku图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_images
-- ----------------------------
INSERT INTO `pms_sku_images` VALUES (96, 32, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//02fc99c4-22a6-4f53-82f3-f8975456429e_oppo1.jpg', 0, 1);
INSERT INTO `pms_sku_images` VALUES (97, 32, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//828c29e1-4828-4e78-8087-521ed181cb53_oppo2.jpg', 0, 0);
INSERT INTO `pms_sku_images` VALUES (98, 33, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//9c53d491-9170-4e72-8997-52f1f878f4de_oppo4.jpg', 0, 1);
INSERT INTO `pms_sku_images` VALUES (99, 33, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//a7ed0fcc-66a4-45d7-8705-ee77f91f9fec_oppo5.jpg', 0, 0);
INSERT INTO `pms_sku_images` VALUES (100, 34, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//eb3ee726-30ea-47ac-862e-a029f9a67077_iPhone131.jpg', 0, 1);
INSERT INTO `pms_sku_images` VALUES (101, 34, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//4fc8459c-8e0e-4d79-80a4-17964f6f4746_iPhone132.jpg', 0, 0);
INSERT INTO `pms_sku_images` VALUES (102, 35, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//4fc8459c-8e0e-4d79-80a4-17964f6f4746_iPhone132.jpg', 0, 1);
INSERT INTO `pms_sku_images` VALUES (103, 35, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//4c0f47ff-402e-4768-8599-deea1b403192_iPhone133.jpg', 0, 0);
INSERT INTO `pms_sku_images` VALUES (104, 36, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//4c0f47ff-402e-4768-8599-deea1b403192_iPhone133.jpg', 0, 1);
INSERT INTO `pms_sku_images` VALUES (105, 36, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//c2024946-f5be-4b57-87db-0904826f18a0_iPhone134.jpg', 0, 0);
INSERT INTO `pms_sku_images` VALUES (106, 37, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//eb3ee726-30ea-47ac-862e-a029f9a67077_iPhone131.jpg', 0, 0);
INSERT INTO `pms_sku_images` VALUES (107, 37, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//c2024946-f5be-4b57-87db-0904826f18a0_iPhone134.jpg', 0, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'sku信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_info
-- ----------------------------
INSERT INTO `pms_sku_info` VALUES (32, 17, 'OPPO Find N 极光蓝 8G', NULL, 225, 13, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//02fc99c4-22a6-4f53-82f3-f8975456429e_oppo1.jpg', 'OPPO Find N 极光蓝 8G', 'a', 8000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (33, 17, 'OPPO Find N 极光蓝 12G', NULL, 225, 13, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//9c53d491-9170-4e72-8997-52f1f878f4de_oppo4.jpg', 'OPPO Find N 极光蓝 12G', 'b', 10000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (34, 18, 'Apple iPhone 13 霓影紫 8G', NULL, 225, 12, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//eb3ee726-30ea-47ac-862e-a029f9a67077_iPhone131.jpg', 'Apple iPhone 13 霓影紫 8G', 'a', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (35, 18, 'Apple iPhone 13 霓影紫 12G', NULL, 225, 12, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//4fc8459c-8e0e-4d79-80a4-17964f6f4746_iPhone132.jpg', 'Apple iPhone 13 霓影紫 12G', 'b', 8000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (36, 18, 'Apple iPhone 13 流光幻镜 8G', NULL, 225, 12, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//4c0f47ff-402e-4768-8599-deea1b403192_iPhone133.jpg', 'Apple iPhone 13 流光幻镜 8G', 'c', 6000.0000, 0);
INSERT INTO `pms_sku_info` VALUES (37, 18, 'Apple iPhone 13 流光幻镜 12G', NULL, 225, 12, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//c2024946-f5be-4b57-87db-0904826f18a0_iPhone134.jpg', 'Apple iPhone 13 流光幻镜 12G', 'd', 8000.0000, 0);
...
CREATE TABLE `pms_sku_sale_attr_value`  (
  ...
  `attr_sort` int(0) NULL DEFAULT NULL COMMENT '顺序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 74 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'sku销售属性&值' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_sku_sale_attr_value
-- ----------------------------
INSERT INTO `pms_sku_sale_attr_value` VALUES (63, 32, 4, '颜色', '极光蓝', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (64, 32, 5, '内存', '8G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (65, 33, 4, '颜色', '极光蓝', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (66, 33, 5, '内存', '12G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (67, 34, 4, '颜色', '霓影紫', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (68, 34, 5, '内存', '8G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (69, 35, 4, '颜色', '霓影紫', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (70, 35, 5, '内存', '12G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (71, 36, 4, '颜色', '流光幻镜', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (72, 36, 5, '内存', '8G', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (73, 37, 4, '颜色', '流光幻镜', NULL);
INSERT INTO `pms_sku_sale_attr_value` VALUES (74, 37, 5, '内存', '12G', NULL);
...
CREATE TABLE `pms_spu_images`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 65 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'spu图片' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_images
-- ----------------------------
INSERT INTO `pms_spu_images` VALUES (58, 17, NULL, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//02fc99c4-22a6-4f53-82f3-f8975456429e_oppo1.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (59, 17, NULL, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//828c29e1-4828-4e78-8087-521ed181cb53_oppo2.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (60, 17, NULL, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//9c53d491-9170-4e72-8997-52f1f878f4de_oppo4.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (61, 17, NULL, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//a7ed0fcc-66a4-45d7-8705-ee77f91f9fec_oppo5.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (62, 18, NULL, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//eb3ee726-30ea-47ac-862e-a029f9a67077_iPhone131.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (63, 18, NULL, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//4fc8459c-8e0e-4d79-80a4-17964f6f4746_iPhone132.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (64, 18, NULL, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//4c0f47ff-402e-4768-8599-deea1b403192_iPhone133.jpg', NULL, NULL);
INSERT INTO `pms_spu_images` VALUES (65, 18, NULL, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//c2024946-f5be-4b57-87db-0904826f18a0_iPhone134.jpg', NULL, NULL);
...
CREATE TABLE `pms_spu_info`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'spu信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of pms_spu_info
-- ----------------------------
INSERT INTO `pms_spu_info` VALUES (17, 'OPPO Find N', '全新折叠旗舰5G新品手机findx3手机oppofindxn 云端', 225, 13, 0.5000, 0, '2022-05-01 17:06:19', '2022-05-01 17:06:19');
INSERT INTO `pms_spu_info` VALUES (18, 'Apple iPhone 13', ' Apple iPhone 13 (A2634)512GB 绿色 支持移动联通电信5G 双卡双待手机', 225, 12, 0.3200, 0, '2022-05-01 17:15:23', '2022-05-01 17:15:23');
...
-- ----------------------------
INSERT INTO `pms_spu_info_desc` VALUES (17, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//2c21db59-fac7-43c2-8b52-9eb050feb2e2_f205d9c99a2b4b01.jpg');
INSERT INTO `pms_spu_info_desc` VALUES (18, 'https://cwl-mall.oss-cn-zhangjiakou.aliyuncs.com/2022-05-01//c4ae10ef-0bdf-45d1-811b-bfd79fcc616d_528211b97272d88a.jpg');
