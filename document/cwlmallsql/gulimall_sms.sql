...
CREATE TABLE `sms_coupon_history`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '优惠券领取历史记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_coupon_spu_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '优惠券与产品关联' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_home_subject`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '首页专题表【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_member_price`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 99 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品会员价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_member_price
-- ----------------------------
INSERT INTO `sms_member_price` VALUES (81, 32, 2, '铜牌会员', 7500.0000, 1);
INSERT INTO `sms_member_price` VALUES (82, 32, 3, '银牌会员', 6500.0000, 1);
INSERT INTO `sms_member_price` VALUES (83, 33, 2, '铜牌会员', 9500.0000, 1);
INSERT INTO `sms_member_price` VALUES (84, 33, 5, '钻石会员', 7500.0000, 1);
INSERT INTO `sms_member_price` VALUES (85, 34, 2, '铜牌会员', 5800.0000, 1);
INSERT INTO `sms_member_price` VALUES (86, 34, 3, '银牌会员', 5600.0000, 1);
INSERT INTO `sms_member_price` VALUES (87, 34, 4, '金牌会员', 5400.0000, 1);
INSERT INTO `sms_member_price` VALUES (88, 34, 5, '钻石会员', 5200.0000, 1);
INSERT INTO `sms_member_price` VALUES (89, 35, 2, '铜牌会员', 7700.0000, 1);
INSERT INTO `sms_member_price` VALUES (90, 35, 3, '银牌会员', 7400.0000, 1);
INSERT INTO `sms_member_price` VALUES (91, 35, 4, '金牌会员', 7100.0000, 1);
INSERT INTO `sms_member_price` VALUES (92, 36, 2, '铜牌会员', 5800.0000, 1);
INSERT INTO `sms_member_price` VALUES (93, 36, 3, '银牌会员', 5600.0000, 1);
INSERT INTO `sms_member_price` VALUES (94, 36, 4, '金牌会员', 5400.0000, 1);
INSERT INTO `sms_member_price` VALUES (95, 36, 5, '钻石会员', 5200.0000, 1);
INSERT INTO `sms_member_price` VALUES (96, 37, 2, '铜牌会员', 7700.0000, 1);
INSERT INTO `sms_member_price` VALUES (97, 37, 3, '银牌会员', 7400.0000, 1);
INSERT INTO `sms_member_price` VALUES (98, 37, 4, '金牌会员', 7100.0000, 1);
INSERT INTO `sms_member_price` VALUES (99, 37, 5, '钻石会员', 6600.0000, 1);
...
CREATE TABLE `sms_seckill_session`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '秒杀活动场次' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_seckill_sku_notice`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '秒杀商品通知订阅' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_seckill_sku_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '秒杀活动商品关联' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sms_sku_full_reduction`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品满减信息' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_sku_full_reduction
-- ----------------------------
INSERT INTO `sms_sku_full_reduction` VALUES (21, 33, 2000.0000, 200.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (22, 34, 12000.0000, 1000.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (23, 35, 16000.0000, 1500.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (24, 36, 12000.0000, 1000.0000, NULL);
INSERT INTO `sms_sku_full_reduction` VALUES (25, 37, 16000.0000, 1500.0000, NULL);
...
CREATE TABLE `sms_sku_ladder`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 34 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品阶梯价格' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_sku_ladder
-- ----------------------------
INSERT INTO `sms_sku_ladder` VALUES (30, 32, 2, 1.00, NULL, 0);
INSERT INTO `sms_sku_ladder` VALUES (31, 34, 3, 1.00, NULL, 1);
INSERT INTO `sms_sku_ladder` VALUES (32, 35, 3, 1.00, NULL, 1);
INSERT INTO `sms_sku_ladder` VALUES (33, 36, 3, 1.00, NULL, 1);
INSERT INTO `sms_sku_ladder` VALUES (34, 37, 3, 1.00, NULL, 1);
...
CREATE TABLE `sms_spu_bounds`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品spu积分设置' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_spu_bounds
-- ----------------------------
INSERT INTO `sms_spu_bounds` VALUES (15, 17, 1000.0000, 1000.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (16, 18, 800.0000, 800.0000, NULL);
