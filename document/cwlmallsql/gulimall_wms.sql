...
-- ----------------------------
INSERT INTO `wms_purchase` VALUES (6, 1, 'admin', '13612345678', 1, 1, NULL, NULL, '2022-05-01 18:32:18', '2022-05-01 18:33:44');
...
-- ----------------------------
INSERT INTO `wms_purchase_detail` VALUES (7, 6, 1, 10, NULL, 1, 1);
INSERT INTO `wms_purchase_detail` VALUES (8, 6, 3, 2, NULL, 1, 1);
...
CREATE TABLE `wms_ware_order_task`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '库存工作单' ROW_FORMAT = Dynamic;
